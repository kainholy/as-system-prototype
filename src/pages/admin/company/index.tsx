    ...
    return (
        <>
            ...
            <Box w="calc(100% - 220px)" margin="0 0 0 auto" position='relative'>
                ...
                { projectOpen && <CompanyProject setProjectOpen={setProjectOpen} setEditOpen={setEditOpen} /> }
                ...
                <Flex
                    ...
                    gap="24px"
                >
                    <Card _hover={{ backgroundColor: 'gray.100', cursor: 'pointer', boxShadow: 'lg' }} transition='.3s' p='17px 18px' onClick={projectOpenFunc}>
                        ...
                        <Flex gap='4px' direction='column' p='10px 0 0'>
                            ...
                            <Text fontSize='xs'>メールアドレス: ookuraseiya0506@gmail.com</Text>
